...
function Strategy(options, verify) {
    ...
    this._oauth2.getOAuthAccessToken = function (code, params, callback) {
        _oauth2_getOAuthAccessToken.call(self._oauth2, code, params, function (err, accessToken, refreshToken, params) {
            ...
            // We probably are already clear to continue with the ID token by parsing it but
            //
 ...
 *
 * @param {string} accessToken, named access token to comply with the base package naming
 * but in this case its an object and not a simple string
 * @param {function} done
 * @access protected
 */
